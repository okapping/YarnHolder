...
let defaultCrochetHookSize = CrochetHookSize(id: 0, mmSize: "0.50", jpSize: "14号", usSize: "", ukSize: "", )
// 毛糸の素材のマスターデータ
let CrochetHookSizes: [CrochetHookSize] = [
    defaultCrochetHookSize,
...
func getCrochetHookSize(by id: Int) -> CrochetHookSize {
    return CrochetHookSizes.first { $0.id == id } ?? defaultCrochetHookSize
}
