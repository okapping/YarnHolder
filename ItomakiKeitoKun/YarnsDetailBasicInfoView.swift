//
//  YarnsDetailBasicInfoView.swift
//  ItomakiKeitoKun
//
...
struct YarnsDetailBasicInfoView: View {
...
//                        .listStyle(.plain)
                    ...
                    ScrollView(.horizontal, showsIndicators: false) {
                        HStack {
                            ForEach(yarnInfo.images, id: \.self) { image in
            ...
            // *******************************************
            // 素材
            Section(header: ListTitleView(title: "KEY_MATERIAL")) {
            ...
            // *******************************************
            // 洗濯表示
            Section(header: ListTitleView(title: "KEY_CARE_LABEL")) {
                HStack {
...
//                header: ListTitleView(title: "基本情報")
            ...
            Section(header: ListTitleView(title: "KEY_MEMO")) {
                Text(yarnInfo.memo)
            }
            Section() {
        ...
        .actionSheet(isPresented: $showYarnDeleteSheet){
            ActionSheet(
                ...
                buttons:[
                    .destructive(Text("KEY_DELETE_YARN_INFO")){
...
#Preview {
    YarnsDetailBasicInfoView(yarnInfo: .init())
}
